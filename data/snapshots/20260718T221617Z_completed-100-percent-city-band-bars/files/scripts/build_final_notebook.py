...
Each equal-length horizontal bar contains all ten selected bands for one city
and totals 100%. Segment 1 is that city's largest current act, segment 2 its
second largest, and so on. The two-line key names every band. This view isolates
composition and concentration; the next chart restores the absolute city
totals.
            """
        ),
        code(
