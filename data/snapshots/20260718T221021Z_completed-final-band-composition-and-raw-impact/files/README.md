...
bands per city after normalization, Sheffield has the greatest current global
Spotify reach relative to built-up-area population; Manchester and Liverpool
follow. This is the primary result. As an additional scene-depth test,
Manchester ranks first after each city's largest selected act is removed,
