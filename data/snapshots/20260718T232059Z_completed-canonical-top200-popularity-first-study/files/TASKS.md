...
- The canonical popularity-first top-200 experiment combines raw origin/FUA
  concentration and strict FUA-population normalization in one notebook.
  Crawley remains in the complete result; one-band FUAs are marked rather than
  removed, and an at-least-two-band view is a stability diagnostic. The former
  canonical top-100 notebook and its two earlier branches remain preserved.
...
- The final notebook now uses the ten largest 2021 OECD/EU Functional Urban
  Areas rather than the inherited mixed built-up-area panel.
- A separate, executed top-20 FUA experiment mirrors the final notebook's
  100% composition, raw-total, population-normalized and largest-band-excluded
  structure using the frozen `20260718T204000Z` Spotify capture.
- The earlier built-up-area final and symmetric-trim top-20 notebook remain
  preserved in checksummed snapshots and dated experiment files.
