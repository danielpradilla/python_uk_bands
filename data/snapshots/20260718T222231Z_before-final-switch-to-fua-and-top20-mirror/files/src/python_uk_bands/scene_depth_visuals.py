...
def plot_ten_band_city_stack(
    ...
    *,
    ...
    ax.set_xlabel(
        "Share of the city's combined current global Spotify monthly listeners"
    )
    ax.set_ylabel("")
    ax.grid(axis="x")
    ax.set_axisbelow(True)
    ...
    return _finish_chart(
        ax,
        number=number,
        title="Selected-band composition within each city",
        subtitle=(
            "Every bar totals 100% · 1 is the city's largest selected band · "
