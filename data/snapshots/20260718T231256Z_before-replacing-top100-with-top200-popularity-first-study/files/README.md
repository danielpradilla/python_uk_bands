...
- [Canonical top-100 popularity-first FUA experiment](notebooks/experiments/snapshots/uk_bands_top100_popularity_first_fua_20260718T204522Z.ipynb)
...
twenty largest UK FUAs. The canonical popularity-first notebook combines raw
geographic concentration, population-adjusted output and a multi-band
stability diagnostic in one narrative; its two earlier branches remain
preserved in the notebook map.
...
It reads the frozen top-100 selection, strict and extended FUA mappings, and
...
scripts/
  ...
  build_popularity_first_canonical_notebook.py canonical top-100 experiment
