...
- The first 100 selected rows exactly reproduce
  `data/processed/popularity_first_top100_20260718T204522Z_bands.csv`.
  The additional range begins with Stereophonics at rank 101 and ends with
  Amber Run at rank 200 (2,165,390 monthly listeners in the frozen capture).
