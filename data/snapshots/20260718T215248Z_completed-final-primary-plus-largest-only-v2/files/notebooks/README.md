...
the all-ten population-normalized result as the primary ranking. It then
removes each city's largest band as one separate scene-depth test. The earlier
five-band comparison and the Google Trends, automated-MusicBrainz,
symmetric-trim and 50-band work remain preserved as experiments, appendices or
history rather than competing headline methods.
